...
For this weekend, you are going to be building a jQuery Carousel. Neat huh? Except, unlike the linked Example, you are going to be building it not with information, but data to be displayed on the page.
...
Inside the JSON file, you will have one object ({ }), inside that object you will have sub objects. One for each person in your cohort. So 19 sub objects. Inside those sub objects, assign three keys. One for their name, one for each description of that person, and finally one key for a shout out for that person (as taken from the daily feedback form. Fill that out more if you have let it slip ;) )
...
Your carousel should have index indicators showing where the user is at in the carousel. Note: If you hit up Code Academy's Build an Interactive Website shows you how to build a carousel with these specifications mentioned in this challenge. I would HIGHLY encourage that you check out how to build a carousel there!